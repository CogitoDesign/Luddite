...
public class DiceNode31 : MonoBehaviour
{
    ...
    {
        if (unlockNode.DieThreenode1IsActive == true && unlockNode.DieThreenode1IsUnlocked == false)
        {
            unlockNode.DieThreenode1IsUnlocked = true;
